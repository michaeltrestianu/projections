...
const App: React.FC = () => {
  ...
  const [averageTransactionValue, setAverageTransactionValue] =
    useState<number>(27);
  const [vybesAwardedPerTransaction, setVybesAwardedPerTransaction] = useState<number>(100);
  const [vybesValueInPounds, setVybesValueInPounds] = useState<number>(0.0005);
  ...
  const [vybesRewards, setVybesRewards] = useState<VybesReward[]>([
    { minTransactionValue: 20, maxTransactionValue: 30, vybes: 10 },
  ]);
